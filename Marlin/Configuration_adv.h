 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN   // PE5, wentylator radiatora hotendu
...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X   0.0        // (Hz) 0 = shaper nieaktywny, czestotliwosc z M593 F po pomiarze
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y   0.0        // (Hz) 0 = shaper nieaktywny, czestotliwosc z M593 F po pomiarze
  ...
  #endif
  #define SHAPING_MIN_FREQ  20.0        // (Hz) jawnie, bo FREQ 0 dzieliloby przez zero przy liczeniu bufora
...
#define MICROSTEP_MODES { 32, 32, 16, 16, 16, 16 }
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.0         // (mm) fallback: LA nieaktywne, K idzie z start gcode per material
  #endif
 ...
 */
   ...
   */
    ...
    //#define STEALTHCHOP_E   // wylaczone: SpreadCycle na E lepiej wspolpracuje z LIN_ADVANCE
  #endif
